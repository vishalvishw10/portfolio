 ...
 ╚██╗ ██╔╝██║╚════██║██╔══██║██╔══██║██║
  ...
  const C = {
    help: () => ['<span class="o">Available commands</span>','',
      ...
      '  <span class="g">tools</span>           free recon tools I built','  <span class="g">contact</span>         get in touch',
      '  <span class="g">socials</span>         social links',
    ...
    tools: () => ['<span class="o">Free recon tools I built</span> <span class="dim">— browser-based, keyless, client-side</span>','',
      '  <span class="g">Subdomain Enumeration</span>  <a href="https://recon.rootxvishal.com" target="_blank" rel="noopener">recon.rootxvishal.com</a>',
      '  <span class="dim">  crt.sh · CertSpotter · DNSRepo · HackerTarget · OTX + live DNS resolve</span>','',
      '  <span class="g">Passive URL Crawler</span>    <a href="https://crawler.rootxvishal.com" target="_blank" rel="noopener">crawler.rootxvishal.com</a>',
      '  <span class="dim">  Wayback · Common Crawl · OTX · URLScan — endpoint discovery + export</span>'],
